...
export default function HomePage() {
  return (
    <div className="w-full min-h-screen flex flex-col text-zinc-100 selection:bg-primary selection:text-black">
      {/* 
      ...
      */}
      ...
      <div className="w-full py-8 px-6 opacity-30 hover:opacity-100 transition-opacity duration-500">
        <div className="max-w-6xl mx-auto border-t border-zinc-800/80 pt-8 flex justify-between items-center font-mono text-[10px] text-zinc-500 uppercase tracking-widest">
